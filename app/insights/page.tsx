...
export default function Insights(){return <main className="inner-page insights-page">
  <section className="insights-hero"><Header/><div className="shell insights-hero-content"><p className="eyebrow">Banking CEE Insights</p><h1>Perspectives From Across the CEE Banking Community.</h1><p>Interviews, discussions and insights from the banking leaders and industry experts shaping financial services across Central &amp; Eastern Europe.</p></div></section>
