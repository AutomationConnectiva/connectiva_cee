    ...
    <main id="top">
      ...
      <section className="journey section-navy">
        <div className="shell journey-grid">
          ...
          <div className="map-card map-real">
            ...
            <span className="map-pin pin-prague">Prague</span><span className="map-pin pin-budapest">Budapest</span><span className="map-pin pin-bucharest">Bucharest</span><span className="map-pin pin-sofia">Sofia</span>
          </div>
        </div>
      </section>
